...
export const NoRead:FC<IconProps> = ({ height, style, width, fill, stroke}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 11 9" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
